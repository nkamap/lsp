...
if(isset($_POST["submit"])){
    $data = [
        ...
        "jumlah_buku_baik" => $_POST["jumlah_buku_baik"],
        "jumlah_buku_rusak" => $_POST["jumlah_buku_rusak"],
    ];
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <div>
                ...
                <input type="number" name="jumlah_buku_baik"  value="<?= $data_buku["jumlah_buku_baik"] ?>">
            </div>

            <div>
                <label>Buku Rusak</label>
                <input type="number" name="jumlah_buku_rusak"  value="<?= $data_buku["jumlah_buku_rusak"] ?>">
            </div>
